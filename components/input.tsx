    ...
    <div className="relative w-full">
      ...
      {status === "streaming" || status === "submitted" ? (
        ...
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full p-2 bg-red hover:bg-zinc-800 disabled:bg-zinc-300 disabled:cursor-not-allowed transition-colors"
        >
